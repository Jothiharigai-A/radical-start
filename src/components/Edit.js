			        ...
			        <form onSubmit={this.handleUpdateUser}>
			      		<div className="modal-body">
			          		...
			          		<div className="form-group">
			            		...
			            		<input type="text" className={`form-control form-control-sm ${this.hasErrorFor('lastname') ? 'is-invalid' : ''}`}lastname
							  ...
							  <div className="form-group">
			            		...
			            		<input type="date" className={`form-control form-control-sm ${this.hasErrorFor('dob') ? 'is-invalid' : ''}`}
			            		 id="dob" name="dob" placeholder="yyyy/mm/dd" onChange={this.handleInputFieldChange} value={this.state.dob}/>
							  ...
							  <div className="form-group">
			            		...
			            		<input type="education" className={ `form-control form-control-sm ${this.hasErrorFor('education') ? 'is-invalid' : ''}`}
			            		 id="education" name="education" placeholder="education" onChange={this.handleInputFieldChange} value={this.state.education}/>
			            		{this.renderErrorFor('education')}
			          		</div>
			      		</div>
			      		<div className="modal-footer">
			        		<button type="submit" className="submit button5">Save Changes</button>
			      		</div>
			   		</form>
			    	</div>
			  	</div>
